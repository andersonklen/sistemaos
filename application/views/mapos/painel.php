    ...
    <div class="quick-actions_homepage">
        <ul class="quick-actions">
            ...
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'), 'vMarca')):?>
                <li class="bg_lg">
                    <a href="<?=base_url()?>index.php/marcas"> <i class="icon-barcode"></i> Marca</a>
                </li>
            <?php endif ?>
                    ...
                    <tbody>
                        <?php if ($ordens != null):?>
                            <?php foreach ($ordens as $o): ?>
                                <tr>
                                    <td><?=$o->os_codigo?></td>
                                    <td><?=date('d/m/Y', strtotime($o->os_data_inicial))?></td>
                                    <td><?=date('d/m/Y', strtotime($o->os_data_final))?></td>
                                    <td><?=$o->cliente_nome_razao?></td>
                                    <td>
                                    <?php if($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')):?>
                                        <a
                                            href="<?=base_url()?>index.php/os/visualizar/<?=$o->os_codigo?>"
                                            class="btn">
