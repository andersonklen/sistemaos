...
CONSTRAINT `fk_os_equipamento1`
    FOREIGN KEY (`os_equipamento_codigo`)
...
CREATE TABLE IF NOT EXISTS `tb_pais` (
  ...
  `pais_sigla` varchar(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_estado` (
  ...
  `estado_nome` varchar(75) DEFAULT NULL,
  `estado_uf` varchar(5) DEFAULT NULL,
  `estado_pais_codigo` int(7) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_cidade` (
  ...
  `cidade_estado_codigo` int(5) DEFAULT NULL,
...
INSERT INTO `tb_pais` (`pais_codigo`, `pais_nome`, `pais_sigla`) VALUES (1, 'Brasil', 'BR');


INSERT INTO `tb_estado` (`estado_codigo`, `estado_nome`, `estado_uf`, `estado_pais_codigo`) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
